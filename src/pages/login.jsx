    ...
    return (
        ...
        <div className="login">
            ...
            <div className="disclaimer-container container">
                ...
                <p className="disclaimer">2. The server may require up to 30 seconds to spin up if the site has been inactive for more than 15 minutes. Please wait after attempting to login or register.</p>
