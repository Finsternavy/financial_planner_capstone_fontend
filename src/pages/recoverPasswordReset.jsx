    ...
    return (
        ...
        <div className="recover-password-reset">
            <div className="container">
                ...
                <div className="form">
                    <input name="temp_password" className="temp-password error-field input reg-field" onChange={onChange} type="text" placeholder="Enter temporary/current password"/>
                    <input name="new_password" className="new-password error-field input reg-field" onChange={onChange} type="password" placeholder="Enter a new password"/>
                    <input className="confirm-password error-field input reg-field" type="password" placeholder="Enter new password again"/>
                </div>
